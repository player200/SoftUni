...
class Program
{
    ...
    static void Main()
    {
        ...
        while ((input = Console.ReadLine()) != "End")
        {
            ...
            {
                case "Private":
                    army.Add(new Private(args[1], args[2], args[3], double.Parse(args[4],CultureInfo.InvariantCulture)));
                    break;
                ...
                case "LeutenantGeneral":
                    ...
                    army.Add(new LeutenantGeneral(args[1], args[2], args[3], double.Parse(args[4], CultureInfo.InvariantCulture), privates));
                    break;
                ...
                case "Commando":
                    ...
                    army.Add(new Commando(args[1], args[2], args[3], double.Parse(args[4], CultureInfo.InvariantCulture), args[5], missions));
                    break;
                ...
                case "Engineer":
                    ...
                    army.Add(new Engineer(args[1], args[2], args[3], double.Parse(args[4], CultureInfo.InvariantCulture), args[5], parts));
                    break;
            }
        }
