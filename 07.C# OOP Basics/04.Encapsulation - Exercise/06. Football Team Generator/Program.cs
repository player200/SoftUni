                ...
                switch (command)
                {
                    ...
                    case "Add":
                        ...
                        else
                        {
                            ...
                            currentTeam.AddPlayers(new Player(tokens[2], int.Parse(tokens[3]), int.Parse(tokens[4]), int.Parse(tokens[5]), int.Parse(tokens[6]), int.Parse(tokens[7])));
                        }
                        break;

                    case "Remove":
                        var teamToRemove = teams.First(t => t.Name == tokens[1]);
                        teamToRemove.RemovePlayers(tokens[2]);
                        break;
